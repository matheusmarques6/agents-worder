...
- **RF-034** Rate limits de proteção do contato (defaults ajustáveis): máx. 1 toque proativo/contato/24h somando todas as origens; máx. 4 toques por funil; cooldown de 72h entre funis distintos. Mensagens reativas nunca são bloqueadas por rate limit.
